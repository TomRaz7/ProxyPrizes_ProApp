...
import {SafeAreaView,StyleSheet,TextInput,View,Text,StatusBar,Button,Image,TouchableOpacity,ScrollView}from 'react-native';
  ...
  return(
    ...
    style={{flex:1, backgroundColor:'#4A86E8',}}>
        <View style={{flexDirection:'row', justifyContent:'center',}}>
            ...
            <Text
            style={{marginTop:25, fontSize:20, fontWeight:'bold', color:'white'}}>ProxyPrizes</Text>
        </View>

    <View style={{backgroundColor:'#4A86E8',alignItems:'center'}}>
        <Text
         style={{fontSize:14, color:'white', marginBottom:10}}>Welcome to the Login Page! Rellena este formulario para entrar</Text>
    </View>
