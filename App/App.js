...
const HomeStackScreen =({navigation})=>(
     ...
     options={{
       ...
       headerLeft:()=>(
          ...
          <TouchableOpacity
            ...
            source={require('/Users/mfoulouyvesmarcel/Desktop/ProAppClone/ProxyPrizes_ProApp/App/src/Images/menu.png')}/>
          </TouchableOpacity>
         ) }}
   />
  ...
  const ShopPendingScreen =({navigation})=>(
    <DiscountUses.Navigator screenOptions={{
      headerStyle:{backgroundColor:'#4169e1'},
      headerTintColor:"#fff",
      headerTitleStyle:{fontWeight:'bold'}
      }}>
    ...
    const DiscountUsesScreen =({navigation})=>(
      ...
      const CreatePostScreen =({navigation})=>(
        <CreatePosts.Navigator screenOptions={{
          headerStyle:{backgroundColor:'#4169e1'},
          headerTintColor:"#fff",
          headerTitleStyle:{fontWeight:'bold'}
          }}>
          <CreatePosts.Screen name="Home"
  ...
  const DetailsStackScreen =({navigation})=>(
    <DetailsStack.Navigator screenOptions={{
      ...
      <DetailsStack.Screen name="Home" component={PostShop} options={{title:'DetailsStack'}} />
    ...
    const TabScreen =({navigation})=>(
      <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name="Home" component={PostShop} options={{title:'DetailsStack'}} />
